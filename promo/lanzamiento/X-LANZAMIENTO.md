# RobinShare — contenido para X · lanzamiento

> Numeros re-verificados contra la cadena el 2026-09-04: la factory creo **UN** vault, su
> `totalPaid()` devuelve 214000000000000 wei. Codigo en **github.com/robinshareapp/robinshare**.
...
Media: `01-hero-desktop.png` o `robinshare-demo-4x5.mp4`.


## 2 · Hilo en inglés

**1/** — 269/280 · media: 03-deed-sealed.png — el acta con el sello al bloque real
...
**2/** — 243/280 · media: 09-explorer-vault-recibo.png — las 4 tx del vault en el explorer
...
**5/** — 270/280 · media: 05-bloque-de-confianza.png — el bloque etiquetado del pie
...
**6/** — 261/280 · media: 04-create-nombrando.png — el formulario nombrando a alguien
...
There's no third: this factory shipped with its third verifier at the zero address, so that route reverts.
```

**7/** — 238/280 · media: 08-explorer-factory-verificada.png — 'verified (exact match)'
...
Read it yourself: github.com/robinshareapp/robinshare
```
...
**9/** — 256/280 · media: robinshare-demo-16x9.mp4 — el demo de 38s
...
No hay una tercera: esta factory salió con su tercer verificador en cero y esa ruta revierte.
```
...
Leelo vos: github.com/robinshareapp/robinshare
```
